package com.fskj.busyviewdemo.View;
...
import com.fskj.busyviewdemo.R;
...
//        imageView.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.rotate_animation));
    ...
    public static BusyView showText(Context context, String text) {
        return show(context,text, false,null);
    }

    public static BusyView show(Context context, CharSequence message, boolean cancelable,
                                OnCancelListener cancelListener) {
        BusyView dialog = new BusyView(context, R.style.LoadingDialogStyle);
        dialog.setTitle("");
